...
The hedonistic model we try to build are using geographically referenced attributes, hence it is also important for us to visual the residual of the hedonistic pricing model.

In order to perform spatial autocorrelation test, we need to convert *condo_resale.sf* from sf data frame into a **SpatialPointsDataFrame**.

First, we will export the residual of the hedonistic pricing model and save it as a data frame.
...
# 6.0 Geographically Weighted Regression (GWR) Method
...
## 6.7 Drawing Statistical Point Map
