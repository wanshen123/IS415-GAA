...
# 6.0 Creating a LISA Cluster Map
...
## 8.2 Mapping Gi values with fixed distance weights
...
## 8.3 Gi statistics using adaptive distance
...
## 8.4 Mapping Gi values with adaptive distance weights
